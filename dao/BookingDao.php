...
class BookingDao {
    ...
    /**
     * Save {@link Todo}.
     * @param ToDo $booking {@link Todo} to be saved
...
//    }
   ...
   $booking->setStatus('pending');
     ...
     * @throws Exception
     */
//    private function update(Todo $booking) {
//        $booking->setLastModifiedOn(new DateTime());
//        $sql = '
//            UPDATE $booking SET
//                priority = :priority,
...
//     (:id, :flight_name, :date_created, :flight_date, :status, :user_id)   
